    ...
    <div class="relative flex flex-col items-center justify-center min-h-screen">
        ...
        <div class="w-full p-6 shadow bg-gray-50 lg:max-w-md">
            ...
            <form class="space-y-4" @submit.prevent="submit">
                ...
                <div>
                    <label for="password" class="block text-sm text-gray-800">Password Confirm</label>
            ...
            <p class="mt-8 text-xs font-light text-center text-gray-700">
                ...
                <RouterLink to="/login" class="font-medium text-purple-600 hover:underline">Login</RouterLink>
